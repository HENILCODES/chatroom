<section class="right-box" style="display: none;" id="right-bot-box">
    <section class="msger">
        ...
        <main class="msger-chat">
            <div id="msger-chat-bot"></div>
            <span id="scroll-bottom-bot"></span>
        ...
        <div class="msger-inputarea">
            ...
            {{ Form::text('chat', '', ['class' => 'msger-input shadow', 'spellcheck' => 'true','id' => 'chatbotText', 'autofocus' => true, 'placeholder' => 'hello .... ', 'autocomplete' => 'off']) }}
